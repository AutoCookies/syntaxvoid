  ...
  describe('commands', () => {
    ...
    describe('open', () => {
      ...
      describe('when the local branch is not tracked', () => {
        ...
        it('opens the GitHub.com blob URL for the file on the local branch', () => {
          spyOn(githubFile, 'openURLInBrowser')
          githubFile.open()
          expect(githubFile.openURLInBrowser).toHaveBeenCalledWith('https://github.com/some-user/some-repo/blob/non-tracked-branch/some-dir/some-file.md')
        })
      })
