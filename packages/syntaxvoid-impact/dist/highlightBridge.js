...
exports.EditorHighlightBridge = void 0;
class EditorHighlightBridge {
    constructor() {
        this.markers = []; // Typed as any because dealing with Atom decorations is complex without full types
    }
    highlight(nodes) {
        this.clear();
...
exports.EditorHighlightBridge = EditorHighlightBridge;
