...
class StatusBarTile {
    ...
    updateStats(risk, depth, circular = false) {
    ...
    updateForActiveItem(item) {
        ...
        if (item.getPath && typeof item.getPath === 'function') {
            ...
            if (path) {
                ...
                const parts = relPath.split('/').map((p) => p.replace(/\.[^/.]+$/, "") // remove extension
...
//# sourceMappingURL=statusBarTile.js.map